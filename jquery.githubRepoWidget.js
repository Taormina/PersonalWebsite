    ...
    $.ajax({
			...
			success: function(results){
                ...
                $('.github-widget').each(function(){
                    ...
                    for (var i = 0; i < len; i++) {
                        if (repos[i].full_name == $container.attr('data-repo')) {
                            var repo = repos[i];
                            break;
                        }
                    }
